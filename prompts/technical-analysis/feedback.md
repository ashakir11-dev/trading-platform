# Technical Analysis: feedback hints

Look for: stops hit soon after entry (stops too tight for the ATR?), entries that
expired unfilled (entry conditions too far away, validity too short?), plans sitting at
a rule limit that then failed, targets rarely reached (targets beyond resistance, or
