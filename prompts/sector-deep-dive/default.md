# Sector Deep Dive: default mode (end-to-end run)
...
3. Treat the sector call as a hypothesis. If the data contradicts it, say so in
   "Sector view", keep screening in the call's direction, and reflect your doubt in
   the scores and your confidence.
