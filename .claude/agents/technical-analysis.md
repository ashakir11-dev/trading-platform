...
description: Technical analysis of the trading pipeline. Reads one company's chart, proposes entry/stop/target for the investor profile and applies the profile's rules. Launched by the middleware agent with a brief, one per candidate.
